...
export function bodyBeforeAfterSlider() {
    const sliderEl = document.querySelector(".body-before-after-slider");
    if (!sliderEl) return;
    ...
    function initSwiper() {
        ...
        if (isMobile()) {
            ...
            const prevBtn = document.querySelector(".body-before-after-slider__button-prev");
            const nextBtn = document.querySelector(".body-before-after-slider__button-next");
            ...
            if (prevBtn && nextBtn) {
                ...
                const finalPrev = document.querySelector(".body-before-after-slider__button-prev");
                const finalNext = document.querySelector(".body-before-after-slider__button-next");
