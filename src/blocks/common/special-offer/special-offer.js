...
export function specialOfferSlider() {
    const sliderEl = document.querySelector(".special-offer-slider");
    if (!sliderEl) return;
    ...
    function initSwiper() {
        ...
        if (isMobile()) {
            ...
            const prevBtn = document.querySelector(".special-offer-slider__button-prev");
            const nextBtn = document.querySelector(".special-offer-slider__button-next");
            ...
            if (prevBtn && nextBtn) {
                ...
                const finalPrev = document.querySelector(".special-offer-slider__button-prev");
                const finalNext = document.querySelector(".special-offer-slider__button-next");
