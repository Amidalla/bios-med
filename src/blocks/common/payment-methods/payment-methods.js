...
export function paymentMethodsSlider() {
    const sliderEl = document.querySelector(".payment-methods-slider");
    if (!sliderEl) return;
    ...
    function initSwiper() {
        ...
        if (isMobile()) {
            ...
            const prevBtn = document.querySelector(".payment-methods-slider__button-prev");
            const nextBtn = document.querySelector(".payment-methods-slider__button-next");
            ...
            if (prevBtn && nextBtn) {
                ...
                const finalPrev = document.querySelector(".payment-methods-slider__button-prev");
                const finalNext = document.querySelector(".payment-methods-slider__button-next");
