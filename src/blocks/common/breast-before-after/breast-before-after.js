...
export function breastBeforeAfterSlider() {
    const sliderEl = document.querySelector(".breast-before-after-slider");
    if (!sliderEl) return;
    ...
    function initSwiper() {
        ...
        if (isMobile()) {
            ...
            const prevBtn = document.querySelector(".breast-before-after-slider__button-prev");
            const nextBtn = document.querySelector(".breast-before-after-slider__button-next");
            ...
            if (prevBtn && nextBtn) {
                ...
                const finalPrev = document.querySelector(".breast-before-after-slider__button-prev");
                const finalNext = document.querySelector(".breast-before-after-slider__button-next");
