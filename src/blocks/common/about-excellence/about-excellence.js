...
export function aboutExcellenceSlider() {
    const sliderEl = document.querySelector(".about-excellence-slider");
    if (!sliderEl) return;
    ...
    function initSwiper() {
        ...
        if (isMobile()) {
            ...
            const prevBtn = document.querySelector(".about-excellence-slider__button-prev");
            const nextBtn = document.querySelector(".about-excellence-slider__button-next");
            ...
            if (prevBtn && nextBtn) {
                ...
                const finalPrev = document.querySelector(".about-excellence-slider__button-prev");
                const finalNext = document.querySelector(".about-excellence-slider__button-next");
